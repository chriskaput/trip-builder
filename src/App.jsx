...
const MODS = [
  ...
  { id:"f4", name:"Gamboa Bakery", category:"restaurant", icon:"🥐", vibe:"Bakery & Café", notes:"A charming bakery and café in Ciudad del Saber. Great pastries, bread, and light bites in a peaceful garden setting. Breakfast here Saturday morning with your friend — show parents a piece of your local community. Worth combining with a walk around the Ciudad del Saber campus.", rec:"recommended", mapsRating:4.4, mapsReviews:"200", hours:"Mon–Sat 7AM–5PM", address:"Ciudad del Saber, Clayton", tier:"curated", cost:"$5–12", tags:["kid-friendly"], photo:"https://images.unsplash.com/photo-1509440159596-0249088772ff?w=600&h=400&fit=crop" },
  { id:"f5", name:"Sassi", category:"restaurant", icon:"🥗", vibe:"Lunch Spot", notes:"A popular lunch spot right next to Kianu's school in Marbella. Fresh, health-conscious food with bold flavors. Great salads, bowls, and lighter fare. Planned for Monday lunch with Kianu and the parents — show them the neighborhood.", rec:"worthit", mapsRating:4.3, mapsReviews:"320", hours:"Mon–Fri 11:30AM–3PM", address:"Marbella", tier:"extended", cost:"$12–18/pp", tags:[], photo:"https://images.unsplash.com/photo-1512621776951-a57141f2eefd?w=600&h=400&fit=crop" },
  ...
  { id:"f7", name:"Mercado de Mariscos", category:"restaurant", icon:"🐟", vibe:"Fish Market & Ceviche", notes:"Panama City's iconic fish market. Go upstairs to the ceviche stands — order a mixed ceviche and a cold Balboa beer. Downstairs is the raw fish market, worth a quick walk through for the experience. Casual, bustling, and authentically Panamanian. Right at the entrance to Casco Viejo — combine with the walking tour.", rec:"cantmiss", mapsRating:4.0, mapsReviews:"6.2K", hours:"Daily 5AM–5PM", address:"Av. Balboa, Casco Viejo", tier:"curated", cost:"$5–12/pp", tags:["kid-friendly","budget"], photo:"https://images.unsplash.com/photo-1534482421-64566f976cfa?w=600&h=400&fit=crop" },
  { id:"f9", name:"Don Caimán", category:"restaurant", icon:"🐊", vibe:"Riverside Dining", notes:"Restaurant at Gamboa Rainforest Resort with an outdoor terrace overlooking the Chagres River where it meets the Canal. The perfect lunch spot after the Monkey Island boat tour. Watch boats navigate the Canal while you eat. Relaxed atmosphere, solid menu — go for the seafood.", rec:"recommended", mapsRating:4.2, mapsReviews:"350", hours:"Daily 12–9PM", address:"Gamboa Rainforest Resort", tier:"curated", cost:"$15–30/pp", tags:["nature"], photo:"https://images.unsplash.com/photo-1414235077428-338989a2e8c0?w=600&h=400&fit=crop" },
  { id:"f10", name:"Maito", category:"restaurant", icon:"🏆", vibe:"Fine Dining", notes:"Panama's top restaurant — ranked #16 in Latin America's 50 Best. Chef Mario Castrellón showcases Panamanian ingredients with modern technique. The tasting menu is the way to go. This is the splurge night (Saturday). Book NOW — Easter weekend means limited availability.", rec:"cantmiss", mapsRating:4.6, mapsReviews:"2K", bookingUrl:"https://www.maitopanama.com", hours:"Tue–Sat 12–3PM, 7–10:30PM", address:"Calle 50, Bella Vista", tier:"curated", cost:"$60–100/pp", tags:["date-night"], photo:"https://images.unsplash.com/photo-1414235077428-338989a2e8c0?w=600&h=400&fit=crop" },
  ...
  { id:"v4", name:"Cerro La Cruz Sunset", category:"activity", icon:"🌅", vibe:"Sunset Viewpoint", notes:"Drive up to the viewpoint for a full panoramic view of the entire valley and surrounding mountains — Pacific Ocean visible on clear days. One of the best sunset spots in the region. Park, walk 2–10 minutes. Higher viewpoint 250m further up has even more dramatic 360° views (short steep 100m walk). Bring a light jacket — wind picks up after 5 PM.", rec:"cantmiss", mapsRating:4.5, mapsReviews:"150", hours:"Best at sunset ~5PM", address:"Cerro La Cruz, El Valle", tier:"curated", cost:"Free", tags:["sunset","nature"], photo:"https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=600&h=400&fit=crop" },
  { id:"v5", name:"Cerro La Silla Hike", category:"activity", icon:"🥾", vibe:"Ridge Hike", notes:"Gorgeous grassy ridgeline hike with 360° views. Two peaks: La Cruz (cross) and La Virgen (statue). Walk as far as you like and turn around. $5 entry, opens 6:00 AM. Budget 1.5–2 hours. Completely exposed: hats, sunscreen, water essential. Outback handles the access road. Stretch option: La India Dormida (~4 miles, steep/rocky) — decide on the day based on energy.", rec:"cantmiss", mapsRating:4.6, mapsReviews:"300", hours:"Daily from 6AM", address:"Cerro La Silla, El Valle", tier:"curated", cost:"$5", tags:["adventure","nature"], photo:"https://images.unsplash.com/photo-1551632811-561732d1e306?w=600&h=400&fit=crop" },
  { id:"v6", name:"Chorro El Macho", category:"activity", icon:"💦", vibe:"Waterfall & Swim", notes:"15–20 min walk across suspension bridges through jungle to a 35m waterfall. Natural swimming pool below the falls — spring-fed, cold, refreshing ($5 extra to swim). Bring swimwear! $5 entry. One of the highlights of El Valle.", rec:"cantmiss", mapsRating:4.4, mapsReviews:"500", hours:"Daily 7AM–5PM", address:"El Valle de Antón", tier:"curated", cost:"$5 entry + $5 swim", tags:["adventure","nature"], photo:"https://images.unsplash.com/photo-1432405972618-c6b0cfba8b31?w=600&h=400&fit=crop" },
  { id:"v7", name:"El Valle Hot Springs", category:"wellness", icon:"♨️", vibe:"Hot Springs", notes:"Four pools of different temperatures plus a mud facial. A relaxing way to wind down after a morning hike. $4 entry. Optional afternoon activity — or head back to El Nancito instead.", rec:"worthit", mapsRating:3.8, mapsReviews:"250", hours:"Daily 8AM–5PM", address:"El Valle de Antón", tier:"extended", cost:"$4", tags:["wellness"], photo:"" },
  { id:"v8", name:"El Nispero Zoo", category:"nature", icon:"🐸", vibe:"Zoo & Gardens", notes:"Animal rescue center, home to the famous golden frog (Panama's national animal). Good botanical garden too. $5 entry, 1–1.5 hours. Optional stop on the e-bike day.", rec:"worthit", mapsRating:4.1, mapsReviews:"180", hours:"Daily 7AM–5PM", address:"El Valle de Antón", tier:"extended", cost:"$5", tags:["nature","kid-friendly"], photo:"" },

  // ═══ HOME / PERSONAL ═══
  { id:"h1", name:"Airport Pickup", category:"home", icon:"✈️", vibe:"Arrival", notes:"Pick up parents at Tocumen International Airport. Drive to Ciudad del Saber (~40 min).", rec:"worthit", mapsRating:0, mapsReviews:"", hours:"Late afternoon", address:"Tocumen International Airport", tier:"extended", cost:"", tags:[], photo:"" },
  ...
  { id:"a3", name:"Cerro Ancón Hike", category:"activity", icon:"🥾", vibe:"City Hike", notes:"Short hike to the highest point in Panama City. 360° panoramic views. Paved trail, 30–45 minutes up. Go early for wildlife (toucans, sloths).", rec:"recommended", mapsRating:4.3, mapsReviews:"2.4K", hours:"Daily 6AM–5PM", address:"Cerro Ancón", tier:"curated", cost:"Free", tags:["nature","walking"], photo:"https://images.unsplash.com/photo-1551632811-561732d1e306?w=600&h=400&fit=crop" },
...
export default function App() {
  ...
  return (
    <div style={{ fontFamily: "'DM Sans',-apple-system,sans-serif", background: "linear-gradient(180deg, #F2F1EE 0%, #E5EAE6 30%, #D8DED9 60%, #CDD5CE 100%)", backgroundAttachment: "fixed", minHeight: "100vh", maxWidth: 430, margin: "0 auto", position: "relative" }}>
      ...
      {showAssist && (() => {
        const ctxPrompts = {
          general: { title: "Trip Assistant", sub: "I know your full itinerary, all experiences, and Panama inside out.", prompts: ["What should we do on a free day?", "Best restaurants for a special dinner?", "What's kid-friendly in our itinerary?", "What's the weather like in late March?"] },
