  ...
  return (
    <div style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.5)", zIndex: 350, display: "flex", alignItems: "flex-end", justifyContent: "center" }} onClick={onClose}>
      <div onClick={e => e.stopPropagation()} style={{ maxWidth: 430, width: "100%", background: "#fff", borderRadius: "24px 24px 0 0", animation: "su 0.25s ease-out", overflow: "hidden" }}>
        <div style={{ display: "flex", justifyContent: "center", padding: "12px 0 4px" }}><div style={{ width: 40, height: 4, background: "#ddd", borderRadius: 2 }} /></div>
...
const Itin = ({ trip, mods, setMods, cal, setCal, onBack, initDay }) => {
  ...
  return (
    <div style={{ fontFamily: "'DM Sans',-apple-system,sans-serif", background: "#F7F6F3", minHeight: "100vh", maxWidth: 430, margin: "0 auto", position: "relative" }}>
      ...
      {/* Header */}
      <div style={{ background: "#fff", padding: "10px 16px 0", borderBottom: "1px solid #eee", position: "sticky", top: 0, zIndex: 100 }}>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 8 }}>
          <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
            <button onClick={onBack} style={{ background: "#f5f5f5", border: "none", borderRadius: 10, padding: "6px 10px", fontSize: 16, cursor: "pointer", color: "#888" }}>←</button>
            <div>
              <h1 style={{ margin: 0, fontSize: 15, fontWeight: 800, fontFamily: "'Playfair Display',Georgia,serif" }}>{trip.name}</h1>
              <div style={{ fontSize: 10, color: "#999", marginTop: 1 }}>{trip.subtitle}</div>
            </div>
          </div>
          <div style={{ display: "flex", gap: 5 }}>
            <button onClick={() => sOv(true)} style={{ background: "#f0f0f0", border: "none", borderRadius: 10, padding: "6px 12px", fontSize: 11, fontWeight: 700, cursor: "pointer", color: "#555" }}>📋 Overview</button>
